...
ggplot(high_earning_df, aes(x=month_of_record, y=mean_index_standardized)) + geom_point() + geom_smooth(method = 'lm') + ggtitle("High-earning schools")
m1 <- feols(mean_index_standardized~month_of_record, data = high_earning_df)

low_earning_df <- final_df %>% filter(earnings <= earning_29)
ggplot(low_earning_df, aes(x=month_of_record, y=mean_index_standardized)) + geom_point() + geom_smooth(method = 'lm') + ggtitle("Low-earning schools")
...
ggplot(final_df_high_low, aes(x=month_of_record, y=mean_index_standardized)) + geom_point() + geom_smooth(method = 'lm') + ggtitle("High/Low-earning schools")
